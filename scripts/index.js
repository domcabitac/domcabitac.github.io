...
function hoverGit(element) {
    element.setAttribute('src', '../images/githubv2.jpg');
}

function unhoverGit(element) {
    element.setAttribute('src', '../images/github.jpg');
}
...
function unhoverVerify(element) {
    element.setAttribute('src', '../images/Verify.jpg');
}

function hoverVerify(element) {
    element.setAttribute('src', '../images/VerifyV2.jpg');
}
